...
<div>
  ...
  <ol class="ml-4 mt-6 list-decimal">
    ...
    <li class="mt-6">You are now ready to REGISTER and begin your training. You can do it here OR call Student Services at <span class="font-bold">888-531-8378.</span></li>
  </ol>
</div>
</template>
